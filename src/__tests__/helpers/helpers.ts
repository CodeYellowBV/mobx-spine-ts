 ...
 * @param expected
 */
 export function modifyObjectNegativeIdCheck(object: Object){
 ...
 * @param expected
 */
function modifyListNegativeIdCheck(expected: Array<any>){
    Array.prototype.forEach.call(expected, (item: any) => {
        if (item < 0){
            // If value
 ...
 */
export function compareObjectsIgnoringNegativeIds(
    object: Object, toEqual: Object, expect: Function, bool: boolean = true
) {
